    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_1', models.EmailField(max_length=255, unique=True, verbose_name='E-mail')),
                ('email_2', models.EmailField(blank=True, max_length=255, null=True, unique=True, verbose_name='E-mail')),
                ('email_3', models.EmailField(blank=True, max_length=255, null=True, unique=True, verbose_name='E-mail')),
